...
class ForgotPasswordScreen extends Component {
  ...
  sendPasswordResetCode = async () => {
    ...
    await this.setState({
      loading: true,
      loadingTxt: "Sending password reset code...",
    });
  ...
  resetPassword = async () => {
    ...
    if (!confCode) {
      const errors = {
        confCodeError:
          "Please input the 4-digit confirmation code sent to your email and phone number",
      };
      await this.setState({ errors });
      return;
    }
    ...
    await this.setState({
      loading: true,
      loadingTxt: "Resetting your password, please wait",
    });
        ...
        >
          <View style={styles.container}>
            <Text style={{ marginBottom: 15, color: "white" }}>
              Input the confirmation code sent to your email and phone number
            </Text>
            <OutlinedTextField
        ...
        >
          <View style={styles.container}>
            <Text style={{ fontSize: 16, color: "#fff" }}>
              Input your email and enter a new password. You will receive a
            ...
            <TouchableOpacity
              ...
              onPress={() => this.sendPasswordResetCode()}
            >
              <Text
                style={{ fontSize: 16, color: "#fff", alignSelf: "center" }}
              >
