...
export default class SelectCoverScreen extends Component {
  ...
  render() {
    const { loading, rate, errors, selectedCover, premium, vehicleCost } =
      this.state;
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.help}>
          Please select how you will be compensated when your car is involved in
          an accident
        </Text>
        ...
        <ScrollView>
          ...
          <TouchableOpacity
            ...
            onPress={() => this.selectCover(coverTypes.comprehensive)}
          >
            <CheckBox
            ...
            <Text style={styles.label}>
              Comprehensive - Compensate me for any damages incured on my car
          ...
          <TouchableOpacity
            style={[
              styles.checkboxContainer,
              selectedCover == coverTypes.thirdParty
                ? styles.checkBoxSelected
                : {},
            ]}
            onPress={() => this.selectCover(coverTypes.thirdParty)}
          >
            <CheckBox
            ...
            />
            <Text style={styles.label}>
              Third Party - Compensate the other person (third party) when I
              damage their vehicle during an accident
            </Text>
          </TouchableOpacity>
